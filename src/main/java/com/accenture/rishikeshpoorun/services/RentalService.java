...
public class RentalService {
	...
	// Method() to get the total rent amount for the specific car rented and returned given Car's Registration Number
	...
	// Method() to get the total rent amount for the specific car rented and returned given Car JAVA ID
	...
	// Method() to get the total rent amount for the cars rented and returned by given User's JAVA ID
	...
	// Method() to get the total rent amount for the cars rented and returned by given User's National ID
